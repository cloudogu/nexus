...
function createRepositoryViaAPI() {
  ...
  curl --request POST -v\
    ...
    --data "{\"name\":\"${name}\",\"online\":true,\"storage\":{\"blobStoreName\":\"default\",\"strictContentTypeValidation\":true,\"writePolicy\":\"allow\"},\"component\":{\"proprietaryComponents\":true},\"raw\":{\"contentDisposition\":\"ATTACHMENT\"}}" \
