FROM registry.cloudogu.com/official/java:21.0.11-1 AS builder
...
ENV NEXUS_VERSION=3.93.0-06 \
    ...
    SHA256_NEXUS_TAR="193996c73200df69210b596ccae84a4251052aa16a6704357bcfe22577d26ceb" \
...
FROM registry.cloudogu.com/official/java:21.0.11-1
